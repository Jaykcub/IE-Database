...
const LABOR_VISIBILITY_ROLES = new Set([
  "FOREMAN",
  "ENGINEER",
  "IE",
  "ADMIN",
...
/** Foreman and above can view who charged labor on jobs. */
export function canViewLaborAttribution(user) {
  if (!user) return false;
  return LABOR_VISIBILITY_ROLES.has(user.role);
}
